...
public class BookServiceLoggerAspect {
    ...
    @Around("execution(public com.example.testspring.domain.Book com.example.testspring.services.impl.BookServiceImpl.findBookById(Long))")
    ...
    @Around("execution(public com.example.testspring.domain.Book com.example.testspring.services.impl.BookServiceImpl.createBook(com.example.testspring.domain.Book))")
    ...
    @Around("execution(public com.example.testspring.domain.Book com.example.testspring.services.impl.BookServiceImpl.updateBook(com.example.testspring.domain.Book))")
